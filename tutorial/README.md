# Vanilla Signal Query 教程脚本

这组文案用于制作 `vanilla-signal-query` 教程视频。前 6 集讲核心 API，第 7 到第 9 集基于 `demo/test.html` 做完整实战。建议每集 8 到 18 分钟。

| 集数 | 文件                                      | 主题                                              |
| ---- | ----------------------------------------- | ------------------------------------------------- |
| 01   | `01-为什么需要-vanilla-query.md`          | 定位、服务端状态、核心能力                        |
| 02   | `02-createQuery-基础请求.md`              | 基本 API、状态字段、loading/error/success         |
| 03   | `03-queryKey-缓存-预取.md`                | queryKey、缓存适配器、staleTime、ttl、prefetch    |
...
- 实战课以 `demo/test.html` 为统一案例，录制时可以边点击页面边讲代码。
